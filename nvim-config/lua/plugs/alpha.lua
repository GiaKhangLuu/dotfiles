return {
  ...
  opts = function()
    ...
    vim.api.nvim_set_hl(0, "NeovimDashboardLogo1", { fg = "#1D8676" })
    vim.api.nvim_set_hl(0, "NeovimDashboardLogo2", { fg = "#26B29D" })
    vim.api.nvim_set_hl(0, "NeovimDashboardLogo3", { fg = "#30DFC4" })
    vim.api.nvim_set_hl(0, "NeovimDashboardLogo4", { fg = "#59E5D0" })
    vim.api.nvim_set_hl(0, "NeovimDashboardLogo5", { fg = "#83ECDC" })
    vim.api.nvim_set_hl(0, "NeovimDashboardLogo6", { fg = "#ACF2E7" })
    vim.api.nvim_set_hl(0, "NeovimDashboardUsername", { fg = "#ACF2E7" })
